...
public class BuildVars {
    ...
    public static int APP_ID = 24475177;
    public static String APP_HASH = "ec5feeafd0258e0b7ad698744bf7f78d";
    ...
    public static boolean isBetaApp() {
        if (betaApp == null) {
            betaApp = ApplicationLoader.applicationContext != null && "org.telegram.messenger.okmand.beta".equals(ApplicationLoader.applicationContext.getPackageName());
        }
        return betaApp;
    }
